...
def add_entry_safe(img_file, filename: str, data: bytes, auto_save: bool = False) -> bool: #vers 3
    """Add entry to IMG file with proper modification tracking - PORTED FROM MODERN SYSTEM"""
    try:
        # Import debug system
        try:
